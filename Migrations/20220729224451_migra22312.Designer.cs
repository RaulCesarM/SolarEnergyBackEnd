...
namespace SolarEnergyBackEnd.Migrations
{
    ...
    [Migration("20220729224451_migra22312")]
    partial class migra22312
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolarEnergyBackEnd.Models.Producao", b =>
                {
                    ...
                    b.Property<int?>("UnidadeProducaoId")
                        .HasColumnType("int");

                    b.HasKey("IdProducao");

                    b.HasIndex("UnidadeProducaoId");
            ...
            modelBuilder.Entity("SolarEnergyBackEnd.Models.Producao", b =>
                {
                    b.HasOne("SolarEnergyBackEnd.Models.Unidade", "UnidadeProducao")
                        .WithMany()
                        .HasForeignKey("UnidadeProducaoId");
